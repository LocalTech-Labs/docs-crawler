...
# Remotion System Prompt for LLMs
...
[Improve this page](https://github.com/remotion-dev/remotion/edit/main/packages/docs/docs/system-prompt.mdx)
...
[Previous\
\
#t= Media Fragments](/docs/media-fragments) [Next\
\
Browser rendering](/docs/miscellaneous/render-in-browser)

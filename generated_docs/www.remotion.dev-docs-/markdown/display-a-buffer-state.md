...
## Implementing a buffer state [​](\#implementing-a-buffer-state "Direct link to Implementing a buffer state")
...
## Making the `<Video>` report buffering [​](\#making-the-video-report-buffering "Direct link to making-the-video-report-buffering")
...
## Pause video and display loading UI [​](\#pause-video-and-display-loading-ui "Direct link to Pause video and display loading UI")
...
[Improve this page](https://github.com/remotion-dev/remotion/edit/main/packages/docs/docs/buffer-state.mdx)
...
- [Implementing a buffer state](#implementing-a-buffer-state)
- [Making the `<Video>` report buffering](#making-the-video-report-buffering)
- [Pause video and display loading UI](#pause-video-and-display-loading-ui)
- [See also](#see-also)

...
### Getting the absolute frame of the timeline [​](\#getting-the-absolute-frame-of-the-timeline "Direct link to Getting the absolute frame of the timeline")
...
[Improve this page](https://github.com/remotion-dev/remotion/edit/main/packages/docs/docs/use-current-frame.mdx)
...
[Previous\
\
useBufferState()](/docs/use-buffer-state) [Next\
\
